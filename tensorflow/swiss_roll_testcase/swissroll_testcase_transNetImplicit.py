...
def train(num_layers, units, epsilon, batch_size, load_model, epochs):
    # specify training
    filename = "saved_models/implicit_" + str(num_layers) + "_" + str(units) + "_e" + str(epsilon)
    ...
    # Create Model
    input_dim = 2  # 2-dimensional datapoint
    output_dim = 2  # one-hot vector of digits 0-1
